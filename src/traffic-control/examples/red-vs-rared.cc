 ...
 *
 * Author: Bhaskar Gautam <bhaskar.16cs04f@nitk.edu.in>,
...
int main (int argc, char *argv[])
{
  ...
  cmd.AddValue ("queueDiscType", "Set Queue disc type to RED or RARED", queueDiscType);
  ...
  if ((queueDiscType != "RED") && (queueDiscType != "RARED"))
    {
      std::cout << "Invalid queue disc type: Use --queueDiscType=RED or --queueDiscType=RARED" << std::endl;
      exit (1);
    }
